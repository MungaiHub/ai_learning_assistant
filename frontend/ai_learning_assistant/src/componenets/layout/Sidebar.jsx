...
import {LayoutDashboard, FileText, BookOpen, User, LogOut, X, Brain} from 'lucide-react'
...
const Sidebar = ({isSidebarOpen, toggleSidebar}) => {
  ...
  ${isSidebarOpen ? 'opacity-100 ' : 'opacity-0 pointer-events-none'}`}
    ...
    ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full '}`}>
        ...
        <div className="flex items-center justify-between p-5 h-16 border-b border-slate-200/60">
